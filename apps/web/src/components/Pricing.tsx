		...
		<section className="py-16 px-4" id="pricing">
			<div className="max-w-3xl mx-auto">
							...
							>
								{y ? (
									<span className="flex items-center gap-1.5">
										Annuel
										<span className="text-[10px] bg-[var(--green)] text-white px-1.5 py-0.5 rounded-full font-bold">
											−15%
										</span>
									</span>
								) : (
					...
					<div className="bg-white rounded-2xl border border-black/8 p-7 space-y-5">
						...
						<ul className="space-y-2.5 text-sm">
							{[
								...
								>
									<span className="text-[var(--muted)] mt-0.5 flex-shrink-0">
										✓
									</span>
									{f}
								</li>
						...
						<ul className="space-y-2.5 text-sm">
							{[
								...
								<li key={f} className="flex items-start gap-2 text-white/80">
									<span className="text-[var(--violet)] mt-0.5 flex-shrink-0">
										✓
									</span>
									{f}
								</li>
				...
				<p className="text-center text-xs text-[var(--muted)] mt-6 max-w-sm mx-auto leading-relaxed">
					Evoly affiche toujours sa commission à l&apos;organisateur <em>et</em>{" "}
					à l&apos;acheteur avant paiement. Aucune surprise.
				</p>
			</div>
		</section>
	);
